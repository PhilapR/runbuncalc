...
- `run.js`: `apply`, `applyAll`, `boxMatrix`, `capAt`, `createRun`, `encounterRules`, `encountersOn`, `fightTier`, `findMon`, `isExcludedVariant`, `learnable`, `levelCap`, `milestones`, `partySpecs`, `planNext`, `requireLayer`, `split`, `splitPrep`, `summarize`, `undo`, `unusedRoutes`, `upcoming`
