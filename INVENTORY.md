...
- `run.js`: `apply`, `applyAll`, `boxMatrix`, `capAt`, `createRun`, `encounterRules`, `encountersOn`, `fightTier`, `findMon`, `isExcludedVariant`, `learnable`, `levelCap`, `milestones`, `partySpecs`, `planNext`, `split`, `splitPrep`, `summarize`, `undo`, `unusedRoutes`, `upcoming`
