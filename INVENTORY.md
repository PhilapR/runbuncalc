...
- `run.js`: `adviseCatches`, `adviseUpgrades`, `apply`, `applyAll`, `boxMatrix`, `capAt`, `createRun`, `encounterRules`, `encountersOn`, `fieldItems`, `fightPlaybook`, `fightTier`, `findMon`, `isExcludedVariant`, `learnable`, `levelCap`, `milestones`, `partySpecs`, `planNext`, `preFightOpportunities`, `rankParties`, `requireLayer`, `rollEncounter`, `rollIvs`, `split`, `splitPrep`, `summarize`, `undo`, `unusedRoutes`, `upcoming`
