...
| P3 | EXP-03 / UI-V4 / BAT-01 | Quiz, later chrome, reverse hop (DBL-02 + RPL-01 shipped) | product | See PLAN §0 |
| P3 | ADP-01 | ~~Batch evaluate CLI + adapter pattern docs~~ **Done** (`scripts/eval-fixtures.js`, `ai/README.md`); optional OpenAPI-ish freeze still open | product | `npm run eval:fixtures`; goldens stay deliberate |
