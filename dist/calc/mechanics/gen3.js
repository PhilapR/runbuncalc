...
function calculateADV(gen, attacker, defender, move, field) {
    ...
    if ((defender.hasAbility('Flash Fire') && move.hasType('Fire')) ||
        (!(0, util_1.isGrounded)(defender, field) && move.hasType('Ground')) ||
    ...
    if ((!isPhysical && defender.hasItem('Deep Sea Scale') && defender.named('Clamperl')) ||
    ...
    const isCritical = move.isCrit && !defender.hasAbility('Battle Armor', 'Shell Armor', 'Magma Armor');
