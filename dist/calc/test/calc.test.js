...
describe('calc', () => {
    describe('Multi-Gen', () => {
        (0, helper_1.inGens)(4, 7, ({ gen, calculate, Pokemon, Move }) => {
        ...
        (0, helper_1.inGens)(4, 7, ({ gen, calculate, Pokemon, Move }) => {
            test(`Arceus Plate (gen ${gen})`, () => {
                const result = calculate(Pokemon('Arceus', { item: 'Meadow Plate' }), Pokemon('Blastoise'), Move('Judgment'));
        ...
        (0, helper_1.inGens)(1, 9, ({ gen, calculate, Pokemon, Move }) => {
        ...
        (0, helper_1.tests)('Comet Punch', ({ gen, calculate, Pokemon, Move }) => {
        ...
        (0, helper_1.inGens)(1, 9, ({ gen, calculate, Pokemon, Move, Field }) => {
        ...
        (0, helper_1.inGens)(3, 9, ({ gen, calculate, Pokemon, Move, Field }) => {
            test(`Weather Ball should change type depending on the weather (gen ${gen})`, () => {
                ...
                for (const { weather, type, damage } of weathers) {
                    ...
                    const result = calculate(Pokemon('Castform'), Pokemon('Bulbasaur'), Move('Weather Ball'), Field({ weather: weather }));
        ...
        (0, helper_1.inGens)(6, 9, ({ gen, calculate, Pokemon, Move }) => {
        ...
        (0, helper_1.inGens)(4, 9, ({ gen, calculate, Pokemon, Move }) => {
        ...
        (0, helper_1.inGen)(8, ({ gen, Pokemon }) => {
        ...
        (0, helper_1.inGens)(7, 9, ({ gen, calculate, Pokemon, Move, Field }) => {
        ...
        (0, helper_1.inGens)(6, 9, ({ gen, calculate, Pokemon, Move }) => {
            test(`Parental Bond (gen ${gen})`, () => {
                let result = calculate(Pokemon('Kangaskhan-Mega', { evs: { atk: 152 } }), Pokemon('Amoonguss', { nature: 'Bold', evs: { hp: 252, def: 152 } }), Move('Frustration'));
                if (gen === 6) {
    ...
    describe('Gen 1', () => {
        (0, helper_1.inGen)(1, ({ calculate, Pokemon, Move, Field }) => {
    ...
    describe('Gen 2', () => {
        (0, helper_1.inGen)(2, ({ calculate, Pokemon, Move, Field }) => {
            test('Basic: Gengar vs. Chansey', () => {
                const result = calculate(Pokemon('Gengar'), Pokemon('Chansey', { item: 'Leftovers' }), Move('Dynamic Punch'));
    ...
    describe('Gen 3', () => {
        (0, helper_1.inGen)(3, ({ calculate, Pokemon, Move, Field }) => {
            test('Basic: Gengar vs. Chansey', () => {
                const result = calculate(Pokemon('Gengar', {
                    nature: 'Mild',
                    evs: { atk: 100 },
                }), Pokemon('Chansey', {
                    item: 'Leftovers',
    ...
    describe('Gen 4', () => {
        (0, helper_1.inGen)(4, ({ calculate, Pokemon, Move }) => {
            test('Basic: Gengar vs. Chansey', () => {
                const result = calculate(Pokemon('Gengar', {
                    item: 'Choice Specs',
                    nature: 'Timid',
    ...
    describe('Gen 5', () => {
        (0, helper_1.inGen)(5, ({ calculate, Pokemon, Move }) => {
            test('Basic: Gengar vs. Chansey', () => {
                const result = calculate(Pokemon('Gengar', {
                    item: 'Choice Specs',
                    nature: 'Timid',
    ...
    describe('Gen 6', () => {
        (0, helper_1.inGen)(6, ({ calculate, Pokemon, Move }) => {
            test('Basic: Gengar vs. Chansey', () => {
                const result = calculate(Pokemon('Gengar', {
                    item: 'Life Orb',
                    nature: 'Modest',
    ...
    describe('Gen 7', () => {
        (0, helper_1.inGen)(7, ({ calculate, Pokemon, Move, Field }) => {
            ...
            test('16-bit Overflow', () => {
                const result = calculate(Pokemon('Mewtwo-Mega-Y', { evs: { spa: 196 } }), Pokemon('Wynaut', { level: 1, boosts: { spd: -6 } }), Move('Fire Blast'), Field({ attackerSide: { isHelpingHand: true } }));
                expect(result.damage).toEqual([
            ...
            test('32-bit Overflow', () => {
                ...
                kyogre = Pokemon('Kyogre', Object.assign(Object.assign({}, kyogre), { overrides: { types: ['Normal'] } }));
    ...
    describe('Gen 8', () => {
        ...
        describe('Gen 9', () => {
            (0, helper_1.inGen)(9, ({ calculate, Pokemon, Move }) => {
