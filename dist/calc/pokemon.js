...
class Pokemon {
    constructor(gen, name, options = {}) {
        ...
        this.types = ((_a = options.overrides) === null || _a === void 0 ? void 0 : _a.types) || this.species.types;
        ...
        this.statOverrides = options.statOverrides ? Object.assign({}, options.statOverrides) : undefined;
        ...
        for (const stat of STATS) {
            ...
            this.stats[stat] = val;
            const override = (_c = this.statOverrides) === null || _c === void 0 ? void 0 : _c[stat];
    ...
    clone() {
        return new Pokemon(this.gen, this.name, {
            ...
            statOverrides: (0, util_1.extend)(true, {}, this.statOverrides),
            soulDewApplied: true,
            ...
            overrides: Object.assign(Object.assign({}, this.species), { types: this.types }),
        });
    }
    calcStat(gen, stat) {
