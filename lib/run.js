 ...
 *
 * `exposureWeight` (default 0, off) charges the six that many points for
 ...
 * (2026-09-18); whether it helps as a term is the --set-exposure arm's
 * question, and it stays off until that is answered.
 *
...
function rankParties(run, trainer, options) {
	...
	const exposureWeight = opts.exposureWeight === undefined ? 0 : opts.exposureWeight;
