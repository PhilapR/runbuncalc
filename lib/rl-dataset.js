...
function battleOutcomeRow(bundle, event) {
	...
	// Trainer fights only. Wild battle.ended events speak a wider vocabulary
	// (outcome 'caught' as well as 'won'/'lost'); the kind filter must stay
	// ahead of the outcome enum so those events are excluded, not corrupted.
