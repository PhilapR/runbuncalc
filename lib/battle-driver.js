 ...
 * switch seats the candidate and asks what the foe does to IT. Off by
 * default: healthiestSwitch sorts by any race it is given, so pricing
 * unconditionally would change the control arm. The battery's
 * --switch-priced arm decides whether it earns the default.
 */
let switchPricingOn = false;
...
module.exports = {start, startWild, act, legalActions, view, streamFor, adjudicate, playbook, catchMath, catchOddsAtFullHp, incomingThreat, setPPModel, setSwitchPricing, switchPricing, benchRace, BALLS};
