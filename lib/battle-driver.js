...
function incomingThreat(state) {
	...
	if (!worst) return {move: null, max: 0, crit: 0, survivesCrit: true, survivesTwoCrits: true};
	return {
		move: worst.move,
...
module.exports = {start, startWild, act, legalActions, view, streamFor, adjudicate, playbook, catchMath, catchOddsAtFullHp, BALLS};
