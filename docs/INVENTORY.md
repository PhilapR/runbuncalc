...
- `run.js`: `adviseCatches`, `adviseUpgrades`, `apply`, `applyAll`, `boxMatrix`, `capAt`, `createRun`, `encounterRules`, `encountersOn`, `evolutionReadiness`, `fieldItems`, `fightPlaybook`, `fightTier`, `findMon`, `isExcludedVariant`, `learnable`, `levelCap`, `milestones`, `partySpecs`, `planNext`, `preFightOpportunities`, `rankParties`, `requireLayer`, `rollEncounter`, `rollIdentity`, `rollIvs`, `split`, `splitPrep`, `summarize`, `undo`, `unusedRoutes`, `upcoming`
