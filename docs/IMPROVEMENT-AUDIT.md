...
| Early catch plan — Route 104 measured at Brawly 2026-09-18 (--swap-catch 19c0d70, receipts 27ba6b8) | Brawly's named answers are all catchable by Route 104 and none of the 19 archive boxes that reach him holds one; every box spent its Route 104 encounter on a non-answer (Sizzlipede, Paras, Ledian, ...). The fight is decided in the first hour of the run, before the ranker or the policy acts | the box's Route 104 catch swapped, level-up moves only (a floor), adopted defaults, 380 paired seeds: control 7.9%; Combee (Vespiquen at 21) 19.7%, +60 / -15, p = 1.6e-7, fielded in 17 of 19; Salandit 9.5% (p = 0.15); Yanma 7.9% (net 0). The evolution data carries no gender condition. Next: the catch planner — per route, the catch the gyms ahead reward — and the same swap with the advisor's TM teaches |
