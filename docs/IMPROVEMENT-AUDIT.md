...
| Price the voluntary switch — lead from the re-pick tapes | the lost-race resist check reads the threat line's move, which is the hardest hit against the active body; price each candidate's entry against the foe's best move into IT, as forced replacements already are | MEASURED (fa8e9aa, receipts 540165b), vetoed, flag stays off: on the 77 held-out fights not read to find it, real PP 227 gained / 143 lost, net +84, p < 0.0001, +68 without the largest trainer; battery 46 / 11 with no veto. Seven primary scenarios lose 5+ net (Karen -11, Lass Haley -8/-7), so the per-scenario veto decides again, as it did for re-pick. Leaders unmoved. With re-pick, fuel-free 391 / 158 against the control, the largest gain measured. Open decision: whether the net -5 veto is the right bar for broad changes across ~80 fights |
