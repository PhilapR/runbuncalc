...
| Pick the six by play — lead from the Roxanne sweep (2026-09-18) | field the ranker's top K sixes through the real policy on selection seeds and send the best, instead of the ranker's score, whose playout policy is not the one that fights | exploration on the fixed engine: at Roxanne the ranker's pWin correlates 0.13 with wins; fixture br-19 ranker #1 0/30 vs its #7 20/30 on fresh seeds (p < 0.0001); sv-8's 10-seed swap did not survive 30 fresh seeds. Arm to be built with a declared bar, selection and evaluation seeds disjoint, held-out fights |
